...
/**
 * Kafka's {@link org.apache.kafka.server.log.remote.metadata.storage.RemoteLogLeaderEpochState} copy in order
 * to get access to {@link AivenRemoteLogLeaderEpochState#offsetToId}  field for serialization purposes.
 * <p>
 ...
 * <p>
 * This is used by {@link AivenRemoteLogMetadataCache} to track the segments for each leader epoch.
 */
class AivenRemoteLogLeaderEpochState {
     ...
     * start offset for the leader epoch. These will be returned by {@link AivenRemoteLogMetadataCache#listAllRemoteLogSegments()}
     * and {@link AivenRemoteLogMetadataCache#listRemoteLogSegments(int leaderEpoch)} so that callers can clean them up if
    ...
    /**
     * Action interface to act on remote log segment transition for the given {@link AivenRemoteLogLeaderEpochState}.
     */
    @FunctionalInterface
    interface Action {
        ...
        void accept(int leaderEpoch,
                    AivenRemoteLogLeaderEpochState remoteLogLeaderEpochState,
                    long startOffset,
